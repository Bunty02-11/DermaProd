...
const Services2 = ({ className = "", specialDetails }) => {
  ...
  const images = [
    specialDetails?.images1,
    specialDetails?.images2,
    specialDetails?.images3
  ];

  console.log("Special Details:", images);
    ...
    <div className={[styles.services, className].join(" ")}>
      ...
      <div className={styles.image}>
        <Image
          ...
          alt="Banner Image"
          src={
            specialDetails?.belowBanner
              ? specialDetails.belowBanner.replace(/ /g, "%20")
